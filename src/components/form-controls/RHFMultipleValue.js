...
import { Card, CardBody, CardHeader, Col, FormFeedback, Label, Row } from 'reactstrap'
...
const RHFMultipleValue = (props) => {
    ...
    return (
        <Fragment>
            <Card className={`${errorobj?.[name] ? "border-danger" : null} mb-0`}>
            ...
            {errorobj[name] && (
                <FormFeedback type="invalid">Required field</FormFeedback>
            )}
        </Fragment>
    )
}
